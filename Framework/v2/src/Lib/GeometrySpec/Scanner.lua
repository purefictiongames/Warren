...
local function extractProperties(part)
    ...
    -- Anchored (only if false, since true is default)
    ...
    elseif type(value) == "table" then
        ...
        if isArray then
            ...
            table.sort(keys, function(a, b)
                -- Put 'id' first, then 'class', then 'shape', then alphabetical
                if a == "id" then return true end
                if b == "id" then return false end
                if a == "class" then return true end
                if b == "class" then return false end
                if a == "shape" then return true end
                if b == "shape" then return false end
                if a == "position" then return true end
                if b == "position" then return false end
                if a == "size" then return true end
                if b == "size" then return false end
...
-- },
        ...
        table.insert(lines, 3, classesTemplate)
    end
