...
-- Navigate to Lib root via script hierarchy
-- DomBuilder is at Lib.Components.Layout.DomBuilder
-- script.Parent = Layout, .Parent = Components, .Parent = Lib
local LibRoot = script.Parent.Parent.Parent
local Dom = require(LibRoot.Dom)
local StyleBridge = require(LibRoot.Dom.StyleBridge)
local Canvas = require(LibRoot.Dom.Canvas)
local Styles = require(LibRoot.Styles)
local ClassResolver = require(LibRoot.ClassResolver)
