...
-- Can be required directly in edit mode: require(game.ReplicatedStorage.Warren.Admin.SaveDataAdmin)
Lib.Admin = require(script.Admin)

-- Test suite is NOT auto-loaded to avoid circular dependency
-- Access via: require(game.ReplicatedStorage.Warren.Tests)

-- Visual demos are NOT auto-loaded to avoid circular dependency
-- Access via: require(game.ReplicatedStorage.Warren.Demos)
