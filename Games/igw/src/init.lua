...
Components.TerrainBlockoutManager = require(script.Pipeline.TerrainBlockoutManager)
Components.FeaturePlacer = require(script.Pipeline.FeaturePlacer)
Components.TopologyBuilder = require(script.Pipeline.TopologyBuilder)
Components.ChunkManager = require(script.Pipeline.ChunkManager)
Components.TopologyTerrainPainter = require(script.Pipeline.TopologyTerrainPainter)
